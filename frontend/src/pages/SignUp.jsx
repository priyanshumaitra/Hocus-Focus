...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1e2939]">
      <div className="max-w-md w-full space-y-8 p-8 bg-[#32445f] rounded-lg shadow-md">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-[#818cf8]">
            Create your account
          </h2>
        </div>
        {error && (
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#432dd7] hover:bg-[#432dd7] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
